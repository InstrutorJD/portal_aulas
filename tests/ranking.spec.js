...
// Turma Jogos tem 50 módulos ao todo (teoria+prática de todas as trilhas de
// todas as matérias com conteúdo) — usados como base do % geral. O % de cada
// aluno é a MÉDIA da fração current/total de cada um dos 50 módulos, não uma
...
const SEED = {
  ...
  student_module_progress: [
    ...
    // csharp/basico) → soma 3 frações de 1.0 / 50 módulos = 6% → arredonda 6%.
...
// nada mais → 1 fração de 1.0 / 50 módulos da turma = 2% → arredonda 2%.
